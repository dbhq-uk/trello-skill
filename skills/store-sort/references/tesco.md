...
2. **🥬 Veg**
   - Root veg → onions/garlic/ginger → cooking citrus (lemons/limes) → tomatoes → peppers/chillies → salad/leaves (cucumber, lettuce, spinach, radishes, avocado) → green veg (broccoli, green beans) → fresh herbs → mushrooms
3. **🍖 Meat & Fish**
